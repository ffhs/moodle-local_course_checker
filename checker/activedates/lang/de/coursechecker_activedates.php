...
$string['activedates_setting_modules_help'] =
    'Definieren Sie die erlaubten Module  (müssen in <a href="{$a}" target="_blank">Aktivitäten verwalten</a> aktiviert sein), die auf aktive Termine geprüft werden sollen.';
